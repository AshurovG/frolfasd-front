...
const ApplicationIcon: React.FC<ButtonProps> = ({onClick, className}) => {
  return <svg className={className}  onClick={onClick} style={{cursor: "pointer"}} fill="#fff" width="30px" height="30px" viewBox="0 0 16 16" id="register-16px" xmlns="http://www.w3.org/2000/svg">
