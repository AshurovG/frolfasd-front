...
const BasketIcon: React.FC<IconProps> = ({onClick}) => {
  //   return <svg onClick={onClick} version="1.1" id="Layer_1" style={{cursor: "pointer"}} fill="#610a0ad1" width="30px" height="30px" viewBox="0 0 512 512"
  ...
  //   </g>
  // </svg>
  return <svg style={{cursor: 'pointer'}} onClick={onClick} xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill="#610a0ad1" viewBox="0 0 16 16">
